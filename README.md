...
## Undo-Stack
An [UndoStack](../VertexCover/master/src/vertexCover/advanced/UndoStack.java "UndoStack") was also created, so that we don't have to make a copy of the graph every time we go one layer deeper into
